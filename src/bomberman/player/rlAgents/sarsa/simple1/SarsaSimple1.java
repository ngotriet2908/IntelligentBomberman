package bomberman.player.rlAgents.sarsa.simple1;
...
public class SarsaSimple1 extends RLPlayer {
...
//    private static final boolean DISABLE_EPSILON = true;
    ...
    //    private int killedNum;
    public SarsaSimple1(ColorType playerColor, String name) {
        super(playerColor, name);
        random = new Random();
        this.killNum = 0;
        this.killedNum = 0;
        try {
            FileInputStream fi = new FileInputStream("src/bomberman/player/rlAgents/sarsa/simple1/trainData/" + this.getName());
    ...
    public void saveQTableToFile(boolean updateAgentData) {
        ...
        try {
            FileOutputStream fileOut = new FileOutputStream("src/bomberman/player/rlAgents/sarsa/simple1/trainData/" + this.getName());
